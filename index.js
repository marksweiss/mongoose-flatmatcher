...
// TODO IMPLEMENT STANDALONE, RE-PASS ALL TESTS
// TODO README
//  - install
//  - plugin loading
//  - use cases and rationale (already done, but add examples)
// TODO
...
//  - add to github with README, .gitignore, .npmignore
//  - email aheckman


// TODO ACCESSORS TO SET TREE DEPTH
var maxDepth = 5;
 ...
 * @api private
 */
exports.getFlatMatcher = function (model, matchArgs) {
  // Helper
	var isArray = function (value) {
	 	return Object.prototype.toString.apply(value) === '[object Array]';
	};
	...
	var matcherLookup = {};
	var depth = 0;
	matcherLookup = this.buildMatcherLookup(pathString, model.schema.tree, matcherLookup, depth);
